...
Ext.define("Sch.feature.SchedulerDragZone", {
    ...
    getDragData : function (e) {
        ...
        var origStart      = eventRecord.getStartDate(),
            ...
            eventBarEls    = s.getElementsFromEventRecord(eventRecord, s.getMode() === 'calendar' ? null : resourceRecord);
    ...
    updateDragContext : function (e) {
        ...
        dd.newResource = s.constrainDragToResource ?
            dd.resourceRecord
            :
            this.resolveResource([proxyRegion.left + dd.offsets[0], proxyRegion.top + dd.offsets[1]]);
