...
Ext.define('Sch.mixin.AbstractSchedulerPanel', {
    ...
    */
    ...
    initStores : function() {
        ...
        if (this.crudManager && !(this.crudManager instanceof Sch.data.CrudManager)) {
            this.crudManager = new Sch.data.CrudManager(this.crudManager);
        }
    ...
    */
    ...
    setResourceStore: function (newResourceStore) {
        ...
        if (this.getCrudManager()) {
            this.getCrudManager().setResourceStore(newResourceStore);
        }
    ...
    */
    ...
    setEventStore: function (newEventStore) {
        ...
        if (this.getCrudManager()) {
            this.getCrudManager().setEventStore(newEventStore);
        }
    ...
    getAssignmentStore: function () {
        ...
        return eventStore && eventStore.isStore && eventStore.getAssignmentStore();
    },
    ...
    setAssignmentStore: function (newAssignmentStore) {
        ...
        if (this.getCrudManager()) {
            this.getCrudManager().setAssignmentStore(newAssignmentStore);
        }
