...
Ext.define('Sch.mixin.SchedulerPanel', {
    ...
    enableRowHeightInjection : function (lockedView, schedulingView) {
        ...
        Ext.Array.each(lockedView.getColumnManager().getColumns(), function (column) {
    ...
    onScheduleResize    : function () {
        ...
        // Save new column width to view model
        var width = this.normalGrid.down('gridcolumn').getWidth();
    ...
    createCalendarColumns : function () {
        ...
        me.timeAxis.forEachAuxInterval(currentHeader.splitUnit, null, function (start, end, i) {
            ...
            if (currentHeader.renderer) {
                header.text = currentHeader.renderer.call(currentHeader.scope || me, start, end, header, i, me.getEventStore());
            } else {
