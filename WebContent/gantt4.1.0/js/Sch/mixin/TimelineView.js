    ...
    setupTooltip : function () {
            ...
            tipCfg = Ext.apply({
                ...
                show : function () {
                    ...
                    if (this.triggerElement && me.getMode() === 'horizontal') {
                        ...
                        var y             = taskBox.top - this.getHeight() - 10;
        ...
        me.tip.on({
            beforeshow : function (tip) {
                // Don't show any tips of some modal window is visible (can happen since Ext.Tooltip normally uses a delayed-show approach)
                if (!tip.triggerElement || !tip.triggerElement.id || Ext.ComponentQuery.query('window[modal=true]{isVisible()}').length > 0) {
                    return false;
                }
