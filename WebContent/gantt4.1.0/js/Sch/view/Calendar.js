    ...
    */
    ...
    renderSingle : function (event) {
        ...
        Ext.Array.each(columns, function (column) {
            ...
            Ext.Array.each(data, function (renderData) {
    ...
    repaintEventsForColumn  : function (column, index) {
        ...
        var rowNode    = view.getNode(0);Ext.DomQuery.selectNode('tr:nth-child(1)', view.el.dom);
        ...
        for (i = 0; i < data.length; i++) {
            ...
            var fly = Ext.get(Ext.DomQuery.selectNode('td:nth-child(' + (index + 1) + ') [id^=' + event.id + '-]', rowNode));
