...
Ext.define("Sch.view.Vertical", {
    ...
    getScheduleRegion: function (resourceRecord, eventRecord) {
        var view        = this.view,
            region      = resourceRecord ? Ext.fly(view.getScheduleCell(0, view.getResourceStore().indexOf(resourceRecord))).getRegion() : view.getTableRegion(),
    ...
    */
    ...
    columnRenderer: function (val, meta, resourceRecord, rowIndex, colIndex) {
        ...
        if (rowIndex === 0) {
            ...
            view.eventLayout.vertical.applyLayout(columnEvents, this.getResourceColumnWidth(resourceRecord) - (2*view.barMargin) - view.cellBorderWidth);
    ...
    relayoutRenderedEvents : function(resource) {
        ...
        view.eventLayout.vertical.applyLayout(data, this.getResourceColumnWidth(resource) - (2*view.barMargin) - view.cellBorderWidth);
