...
Ext.define('Gnt.data.DependencyStore', {
    ...
    onDependencyAdd : function (me, dependencies) {
        ...
        !me.ignoreInitial && Ext.Array.each(dependencies, function(dependency) {
            var from, to;
            ...
            if (from && to) {
                // TODO: move this into a separate cache instance as it's done in/for assignment store
    ...
    onDependencyRemove : function (me, dependencies, index, isMove) {
        ...
        Ext.Array.each(dependencies, function (dependency) {
            ...
            // TODO: move this logic into a separate cache instance as it's done in/for assignments store
            if (from) {
            ...
            if (to) {
                ...
                if (!me.isUndoingOrRedoing() && !to.isManuallyScheduled() && to.isTaskStored()) {
