    ...
    updateFieldReadOnly : function (field) {
        ...
        if (!field.disabled) {
            ...
            if (field.editable === false) {
                // if the form is readOnly or the field is not editable
                if (me.getReadOnly() || !me.taskBuffer.isEditable(field.name)) {
            ...
            // if the form is readOnly or the field is not editable
                ...
                field.setReadOnly(me.getReadOnly() || !me.taskBuffer.isEditable(field.name));
            }
        }
    },
