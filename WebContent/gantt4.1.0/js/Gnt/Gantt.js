Ext.define('GanttApp.GanttPanel', {
    ...
    requires : [
        ...
        'GanttApp.Filter',
        'GanttApp.SecondaryToolbar',
		'GanttApp.PrimaryToolbar', 
        'Gnt.plugin.Export'
    ],
	...
	exportPlugin            :
	    ...
	    initComponent           : function () {
	        ...
	        Ext.apply(this, {
	            ...
	            // Define properties for the left 'locked' and scrollable tree
				// grid
	            lockedGridConfig : {
	                width : 400
	            },
	            ...
	            // Define what should be shown in the left label field, along
				// with the type of editor
	            leftLabelField : {
	                dataIndex : 'Name',
	            ...
	            plugins : [
	                       Ext.create("GanttApp.TaskContextMenu"),
	                'scheduler_pan',
	                'gantt_taskeditor',
	                'gantt_projecteditor',
	                {
	                ...
	                },
	                {
	                    ...
	                    // data copied in raw format can be copied and pasted to
						// gantt
	                    // data in text format is copied to system clipboard and
	            ...
	            eventRenderer : function (task, tplData) {
	                ...
	                if (task.get('Color')) {
	                    ...
	                    // since it will set color of background visible between
						// segments
	                    // in this case instead we need to provide "style" for
