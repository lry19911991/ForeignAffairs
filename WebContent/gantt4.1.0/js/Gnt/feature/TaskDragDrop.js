...
Ext.define("Gnt.feature.TaskDragDrop", {
    ...
    onDragOver : function (e) {
        ...
        var timeDiff    = gantt.getDateFromCoordinate(e.getXY()[ 0 ]) - dragContext.startPointDate;
    ...
    finalize    : function (updateRecords) {
        ...
        if (updateRecords) {
            ...
            if (dragContext.isTaskDrag) {
                task.setStartDate(start, true, this.skipWeekendsDuringDragDrop, function(cancelChanges, affectedTasks) {
                    ...
                    if (previousStartDate - currentStartDate !== 0) {
                        ...
                        if (Ext.isIE9) {
                            ...
                            Ext.Function.defer(me.onValidDrop, 10, me, dragContext.ddCallbackArgs);
                        } else {
