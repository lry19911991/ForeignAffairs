...
Ext.define('Gnt.model.Resource', {
    ...
    constructor: function() {
        ...
        if (this.phantom) {
            // For use in ResourceStore to help assignment store resolve realized phantom records after store write
    ...
    assignTo : function (taskOrId, units, callback) {
        var task    = taskOrId instanceof Gnt.model.Task ? taskOrId : this.getTaskStore().getNodeById(taskOrId);
