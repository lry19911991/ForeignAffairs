...
Ext.define('Gnt.model.Assignment', {
    ...
    */
    ...
    getTask: function (taskStore) {
        // removed assignment will not have "this.joined" so we are providing a way to get the task via provided taskStore
        taskStore = taskStore || this.joined && this.joined[ 0 ].getTaskStore();
        return taskStore && taskStore.getByInternalModelId(this.getTaskId());
    },
