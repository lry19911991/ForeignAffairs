...
Ext.define('Gnt.data.DependencyStore', {
    ...
    onDependencyUpdate : function (me, dependency, operation) {
        if (operation != Ext.data.Model.COMMIT) {
            ...
            if (fromChanged) {
                var oldFromTask = taskStore.getNodeById(previous[ dependency.fromField ]);
            ...
            if (toChanged) {
                var oldToTask   = taskStore.getNodeById(previous[ dependency.toField ]);
    ...
    getTaskById : function (id) {
        var task    = this.getTaskStore().getNodeById(id);
