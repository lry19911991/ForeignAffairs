    ...
    */
    ...
    setupPartnerTimelinePanel : function () {
        ...
        var otherView = otherPanel.getSchedulingView(),
            otherViewEl = otherView.getEl(),
            otherScrollSource = otherView.scrollManager ? otherView.scrollManager.scroller : otherViewEl,
            ownView = this.getSchedulingView(),
            ownViewEl = ownView.getEl(),
            ownScrollSource = ownView.scrollManager ? ownView.scrollManager.scroller : ownViewEl;

        otherPanel.mon(ownScrollSource, 'scroll', function (e, el) {
            otherView.setScrollX(ownView.getScroll().left);
        });

        this.mon(otherScrollSource, 'scroll', function (e, el) {
            ownView.setScrollX(otherView.getScroll().left);
        });
